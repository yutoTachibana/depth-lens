...
>
> ⚠ **Read this first**: this is a **research finding about over-
> provisioning of frontier APIs on bounded-depth synthetic tasks**.
> It is *not* a production recommendation to deploy a 1M-parameter
> looped transformer. See the **"When this finding applies — and when
> it doesn't"** section below before quoting the headline ratio.
